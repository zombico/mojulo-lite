/**
 * VectorRAG — runtime sibling to SimpleRAG.
 *
 ...
 *
 * No fallback to keyword. If the model fails to load, queries fail loudly
 * — the artifact has no documents/*.txt to fall back to.
 */
...
class VectorRAG {
  ...
  /**
   * Mirror of SimpleRAG.search — returns a string the LLM gets injected with,
   * or '' on miss. Throws on embedder/transport failures (no silent degrade).
   */
